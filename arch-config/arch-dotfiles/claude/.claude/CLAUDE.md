...
* Always use the researcher agent to fetch up to date documentation that is relevant
...
* If an AGENTS.md file exists in the project root, always read it at the start of each session.
*  No more checkboxes or "generated by" footer in PR descriptions. Keep PR descriptions concise going forward.
