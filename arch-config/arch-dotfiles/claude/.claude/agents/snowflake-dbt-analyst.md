...
description: |
  ...
  <example>
  Context: The user is building a dbt mart and needs guidance on intermediate models.
  user: "We need an intermediate model for sessionized events and a mart for daily KPIs."
  assistant: "I'll use the Task tool to launch the snowflake-dbt-analyst agent
...
You should always ask questions to clarify intent behind questions asked to help guide the explorations.
