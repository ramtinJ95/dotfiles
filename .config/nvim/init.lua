...
-- Center code in middle of screen when coding on wide screen
...
-- Enable nvim tree for folder-explorer
...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'c', 'cpp', 'go', 'lua', 'python', 'rust', 'typescript','vim', 'sql', 'hcl', 'java' },

  highlight = { enable = true },
  indent = { enable = true, disable = { 'python', 'c', 'rust', 'Makefile'} },
...
local on_attach = function(_, bufnr)
  ...
  -- Vertical movement made smoother
  nmap("<C-d>", "<C-d>zz")
  nmap("<C-u>", "<C-u>zz")
  nmap("n", "nzzzv")
  nmap("N", "Nzzzv")
