...
- `README.md:132` and `mac-config/mac-install/README.md:25` still use placeholder clone URLs even though this repo has a real remote, which keeps fresh-machine setup copy-paste unfriendly.
- `README.md:64-105`, `mac-config/mac-install/README.md:43-50`, and `arch-config/arch-dotfiles/README.md:30-49` duplicate Stow install/restow commands instead of routing through one checked script, which makes package-list changes easy to document inconsistently.
