General rules
  <rules>
    <rule>Agents MUST use the ctx7 CLI (for example via `npx ctx7 ...`) to fetch up-to-date documentation that is relevant to the project currently being worked on.</rule>
