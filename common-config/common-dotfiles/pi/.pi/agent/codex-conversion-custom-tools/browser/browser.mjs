...
const REMOTE_TOOL_PATH =
	"/home/igorw/.pi/agent/codex-conversion-custom-tools/browser/browser.mjs";
...
export function browserHelp() {
	return {
		call: "await tools.browser(JSON.stringify({ host?, response_length?, tabs?, open?, find?, click?, ... }))",
